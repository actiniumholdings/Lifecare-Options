...
export function CareersContent() {
  ...
  return (
    <>
      ...
      {/* 6. Open roles — dark */}
      <Section tone="dark">
        <Eyebrow className="!text-peach-tint">{t("openRoles.eyebrow")}</Eyebrow>
        ...
        {siteConfig.positions.length === 0 ? (
          <div className="mt-8 max-w-xl">
            ...
            <p className="mt-3 text-white/80 leading-relaxed">{t("openRoles.emptyBody")}</p>
          </div>
        ) : (
          <ul className="mt-8 space-y-4">
            {siteConfig.positions.map((pos) => (
              <li key={pos.title} className="text-white">
                ...
                {pos.type && <span className="ml-2 text-sm text-white/70">{pos.type}</span>}
              </li>
            ))}
          </ul>
        )}
      ...
      <Section tone="dark">
        <div className="max-w-2xl mx-auto text-center">
          <Eyebrow className="!text-peach-tint">{t("bilingual.eyebrow")}</Eyebrow>
          <h2 className="mt-4 text-white">{t("bilingual.title")}</h2>
          <p className="mt-4 text-white/80 leading-relaxed">{t("bilingual.body")}</p>
        </div>
      </Section>
