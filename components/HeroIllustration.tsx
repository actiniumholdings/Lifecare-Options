...
export function HeroIllustration({ className }: HeroIllustrationProps) {
  return (
    <Image
      ...
      alt="A pencil-sketch illustration of a caregiver seated beside an elderly woman on a couch, the caregiver's hand resting gently on her shoulder. Behind them is a sunlit window, a lamp, and potted plants."
      width={SKETCH_W}
      height={SKETCH_H}
      priority
